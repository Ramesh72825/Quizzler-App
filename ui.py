...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, width=300, text="Miss You Ramesh", fill=THEME_COLOR, font=("Ariel", 20, "italic"))
        self.canvas.grid(column=0, row=1, columnspan=2, pady=50)

        self.check_img = PhotoImage(file="images/true.png")
        self.true_button = Button(image=self.check_img, highlightthickness=0, command=self.true_pressed)
